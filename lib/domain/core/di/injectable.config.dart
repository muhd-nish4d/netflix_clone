...
import '../../../infrastructure/downlaods/downloads_repository.dart' as _i4;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i3.IDownloadsRespo>(() => _i4.DownloadsRepository());
  gh.lazySingleton<_i5.SearchService>(() => _i6.SearchImp());
  gh.factory<_i7.DownloadsBloc>(
      () => _i7.DownloadsBloc(get<_i3.IDownloadsRespo>()));
  gh.factory<_i8.SearchBloc>(() => _i8.SearchBloc(
        get<_i3.IDownloadsRespo>(),

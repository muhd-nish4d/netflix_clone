...
import '../../../infrastructure/downlaods/downloads_repository.dart' as _i6;
...
import '../../hot_and_new/hot_and_new_response.dart' as _i3;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i5.IDownloadsRespo>(() => _i6.DownloadsRepository());
  gh.lazySingleton<_i7.SearchService>(() => _i8.SearchImp());
  gh.factory<_i9.DownloadsBloc>(
      () => _i9.DownloadsBloc(get<_i5.IDownloadsRespo>()));
  gh.factory<_i10.FastLaughBloc>(
      () => _i10.FastLaughBloc(get<_i5.IDownloadsRespo>()));
  gh.factory<_i11.HotAndNewBloc>(
      () => _i11.HotAndNewBloc(get<_i3.HotAndNewService>()));
  gh.factory<_i12.SearchBloc>(() => _i12.SearchBloc(
        get<_i5.IDownloadsRespo>(),
